...
Register.propTypes = {
  ...
  isAuthenticated: PropTypes.bool // Add this if you want to check authentication status
}
...
export default connect(mapStateToProps, { setAlert, register })(Register); // Connect to Redux store if needed
